...
const AboutSection = () => {
  ...
  const languages = [
    ...
    },
    {
      ...
      description: "Studied at Collège De La Salle – Frères Daher, a distinguished French-language institution, where I completed my education in mathematics and science entirely in French."
    },
    {
      name: "English",
      level: "Fluent",
      icon: <BookOpen className="w-5 h-5" />,
      description: "Developed through multiple channels: school education, university studies, technical work, and ongoing academic and professional engagement."
    }
  ];
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          {languages.map((language, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="bg-slate-800/90 backdrop-blur-md border-slate-700/50 hover:bg-slate-700/50 transition-all duration-300 h-full">
