  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "ahmed25hassan13@gmail.com",
            ...
            <div className="space-y-6 mb-8">
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  viewport={{ once: true }}
                  className="flex items-center space-x-4 text-gray-600 hover:text-blue-600 transition-colors duration-300"
                >
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-600 text-center md:text-right">
              <p>&copy; 2024 Ahmed Rashad. All rights reserved.</p>
            </div>
          </div>
        </motion.footer>
      </div>
