  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <motion.div className="flex justify-center items-center -ml-2" initial={{
          opacity: 0,
          x: -50
        }} animate={{
          opacity: 1,
          ...
          delay: 0.2
            ...
            {/* Main Title */}
            <motion.h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            {/* Professional Titles */}
            <motion.div className="text-sm md:text-base mb-4" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            {/* Description */}
            <motion.p className="text-sm md:text-base text-white/90 mb-6 leading-relaxed drop-shadow-sm" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            duration: 0.8,
            delay: 0.8
          }}>A passionate mechatronics engineering student at MSA University speaking Arabic, English and French who loves building smart solutions that blend electronics, mechanical design, and software development.</motion.p>

            {/* Action Buttons */}
            <motion.div className="flex flex-col sm:flex-row justify-center lg:justify-start items-center gap-3 mb-6" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            delay: 1.0
              ...
              <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white px-6 py-3 text-sm rounded-full shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 transform hover:scale-105 border-0" onClick={() => document.querySelector("#projects")?.scrollIntoView({
              behavior: "smooth"
            })}>
                <span className="mr-2">🚀</span>
                Explore My Work
              </Button>
              <Button variant="outline" size="lg" className="border-2 border-white/30 text-white hover:border-white/50 px-6 py-3 text-sm rounded-full transition-all duration-300 transform hover:scale-105 bg-white/10 hover:bg-white/15 backdrop-blur-md">
            ...
            {/* Social Links */}
            <motion.div className="flex justify-center lg:justify-start items-center space-x-4" initial={{
            opacity: 0,
            y: 30
          }} animate={{
            opacity: 1,
            ...
            delay: 1.2
              ...
              {socialLinks.map((link, index) => <motion.a key={link.name} href={link.href} target="_blank" rel="noopener noreferrer" whileHover={{
              scale: 1.1,
              y: -3
            }} whileTap={{
              scale: 0.95
              ...
              duration: 0.5,
              delay: 1.3 + index * 0.1
            }} className="p-2.5 bg-white/10 backdrop-blur-md rounded-full text-white/90 hover:text-white hover:bg-white/15 transition-all duration-300 shadow-lg hover:shadow-xl border border-white/20" onClick={e => e.stopPropagation()}>
                  {link.icon}
                </motion.a>)}
            </motion.div>
          </motion.div>
        ...
        <motion.div className="absolute bottom-3 left-1/2 transform -translate-x-12" initial={{
        opacity: 0
      }} animate={{
        opacity: 1
      }} transition={{
        ...
        delay: 1.4
          ...
          repeat: Infinity
            ...
            <div className="w-5 h-8 border-2 border-current rounded-full flex justify-center">
              <motion.div className="w-1 h-2 bg-current rounded-full mt-1.5" animate={{
              opacity: [1, 0, 1]
            }} transition={{
              duration: 2,
              repeat: Infinity
