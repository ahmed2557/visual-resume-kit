    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          >
            <div className="w-80 h-80 lg:w-96 lg:h-96 bg-gradient-to-br from-cyan-400/20 to-purple-500/20 rounded-full border-4 border-white/30 backdrop-blur-md flex items-center justify-center">
          ...
          >
            ...
            >
              <p className="leading-relaxed font-light text-white drop-shadow-md mb-2">
            ...
            {/* Description */}
            <motion.p 
              className="text-base md:text-lg text-white/90 mb-8 leading-relaxed drop-shadow-sm"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white px-8 py-6 text-base rounded-full shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 transform hover:scale-105 border-0"
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-2 border-white/30 text-white hover:border-white/50 px-8 py-6 text-base rounded-full transition-all duration-300 transform hover:scale-105 bg-white/10 hover:bg-white/15 backdrop-blur-md"
              >
            ...
            >
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  className="p-3 bg-white/10 backdrop-blur-md rounded-full text-white/90 hover:text-white hover:bg-white/15 transition-all duration-300 shadow-lg hover:shadow-xl border border-white/20"
                >
                  {link.icon}
                </motion.a>
              ))}
