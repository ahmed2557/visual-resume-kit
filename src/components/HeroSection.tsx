...
const HeroSection = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0">
          <motion.div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-purple-600/30 to-purple-800/30 rounded-full blur-3xl" animate={{
          x: [0, 100, 0],
          y: [0, 50, 0]
        }} transition={{
          duration: 8,
          ...
          <motion.div className="absolute top-1/4 right-0 w-80 h-80 bg-gradient-to-br from-blue-600/30 to-blue-800/30 rounded-full blur-3xl" animate={{
          x: [0, -80, 0],
          y: [0, 80, 0]
        }} transition={{
          duration: 10,
          ...
          <motion.div className="absolute bottom-0 left-1/3 w-72 h-72 bg-gradient-to-br from-cyan-600/30 to-cyan-800/30 rounded-full blur-3xl" animate={{
          x: [0, 60, 0],
          y: [0, -60, 0]
        }} transition={{
          duration: 12,
        ...
        {/* Floating particles */}
        {[...Array(15)].map((_, i) => <motion.div key={i} className="absolute w-1 h-1 bg-white/40 rounded-full" style={{
      ...
      <div className="max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        duration: 0.8
          ...
          {/* Professional Titles */}
          <motion.div className="text-xl md:text-2xl mb-8 max-w-5xl mx-auto" initial={{
          opacity: 0,
          y: 30
        }} animate={{
          opacity: 1,
          ...
          {/* Description */}
          <motion.p className="text-lg md:text-xl text-white/90 mb-12 max-w-4xl mx-auto leading-relaxed drop-shadow-sm" initial={{
          opacity: 0,
          y: 30
        }} animate={{
          opacity: 1,
          ...
          {/* Action Buttons */}
          <motion.div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-16" initial={{
          opacity: 0,
          y: 30
        }} animate={{
          opacity: 1,
          ...
          delay: 0.8
            ...
            <Button size="lg" className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white px-12 py-7 text-lg rounded-full shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 transform hover:scale-105 border-0" onClick={() => document.querySelector("#projects")?.scrollIntoView({
            behavior: "smooth"
          })}>
              <span className="mr-2">🚀</span>
              Explore My Work
            </Button>
            <Button variant="outline" size="lg" className="border-2 border-white/50 text-white hover:border-white/70 px-12 py-7 text-lg rounded-full transition-all duration-300 transform hover:scale-105 bg-gradient-to-r from-purple-500/20 to-cyan-500/20 backdrop-blur-sm bg-rose-950 hover:bg-rose-800">
          ...
          {/* Social Links */}
          <motion.div className="flex justify-center items-center space-x-8 mb-16" initial={{
          opacity: 0,
          y: 30
        }} animate={{
          opacity: 1,
        ...
        delay: 1.4
          ...
          repeat: Infinity
            ...
            <div className="w-6 h-10 border-2 border-current rounded-full flex justify-center">
              <motion.div className="w-1 h-3 bg-current rounded-full mt-2" animate={{
              opacity: [1, 0, 1]
            }} transition={{
              duration: 2,
              repeat: Infinity
