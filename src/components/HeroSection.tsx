      ...
      <div className="max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        duration: 0.8
          ...
          delay: 0.8
            ...
            <Button variant="outline" size="lg" className="border-2 border-white/30 text-white hover:border-white/50 px-12 py-7 text-lg rounded-full transition-all duration-300 transform hover:scale-105 bg-white/10 hover:bg-white/15 backdrop-blur-md">
          ...
          delay: 1.0
            ...
            duration: 0.5,
            delay: 1.1 + index * 0.1
          }} className="p-4 bg-white/10 backdrop-blur-md rounded-full text-white/90 hover:text-white hover:bg-white/15 transition-all duration-300 shadow-lg hover:shadow-xl border border-white/20">
                {link.icon}
              </motion.a>)}
          </motion.div>
        </motion.div>
