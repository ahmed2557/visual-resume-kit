    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[80vh]">
          ...
          {/* Left Section - Photo Area - Mobile: Order 1, Desktop: Order 1 */}
          <motion.div 
            className="flex justify-center items-center order-1 lg:order-1 lg:-ml-2" 
            initial={{ opacity: 0, x: -50 }} 
            animate={{ opacity: 1, x: 0 }} 
            transition={{ duration: 0.8 }}
          >
            <div className="w-64 h-64 sm:w-72 sm:h-72 lg:w-80 lg:h-80 bg-gradient-to-br from-cyan-400/20 to-purple-500/20 rounded-full border-4 border-white/30 backdrop-blur-md flex items-center justify-center">
              <div className="text-white/60 text-center">
                <div className="text-4xl sm:text-5xl mb-3">📸</div>
                <p className="text-sm sm:text-base">Your Photo Here</p>
              </div>
            </div>
          </motion.div>

          {/* Right Section - Content - Mobile: Order 2, Desktop: Order 2 */}
          <motion.div 
          ...
          >
            ...
            {/* Description */}
            <motion.p 
              className="text-xs sm:text-sm md:text-base text-white/90 mb-6 leading-relaxed drop-shadow-sm" 
              initial={{ opacity: 0, y: 30 }} 
              animate={{ opacity: 1, y: 0 }} 
              transition={{ duration: 0.8, delay: 0.8 }}
            >
              A passionate mechatronics engineering student at MSA University speaking Arabic, English and French who loves building smart solutions that blend electronics, mechanical design, and software development.
            </motion.p>
            ...
            >
              <Button
                size="lg"
                className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white px-4 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm rounded-full shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 transform hover:scale-105 border-0 w-full sm:w-auto"
              ...
              <Button
                variant="outline"
                size="lg" 
                className="border-2 border-white/30 text-white hover:border-white/50 px-4 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm rounded-full transition-all duration-300 transform hover:scale-105 bg-white/10 hover:bg-white/15 backdrop-blur-md w-full sm:w-auto"
              >
            ...
            {/* Social Links */}
            <motion.div 
              className="flex justify-center lg:justify-start items-center space-x-3 sm:space-x-4" 
              initial={{ opacity: 0, y: 30 }} 
              animate={{ opacity: 1, y: 0 }} 
            ...
            >
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  className="p-2 sm:p-2.5 bg-white/10 backdrop-blur-md rounded-full text-white/90 hover:text-white hover:bg-white/15 transition-all duration-300 shadow-lg hover:shadow-xl border border-white/20"
        ...
        <motion.div 
          className="absolute bottom-3 left-1/2 transform -translate-x-1/2 lg:-translate-x-12" 
          initial={{ opacity: 0 }} 
          animate={{ opacity: 1 }} 
        ...
        >
          ...
          >
            <span className="text-xs font-medium mb-2 opacity-80 group-hover:opacity-100 drop-shadow-sm">
              Scroll Down
            </span>
